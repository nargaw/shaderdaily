...
const fragmentShader = glsl`
    ...
    void main()
    {
        ...
        coords4.y += cos(u_time)/3.5;
        coords4.x += sin(u_time)/3.5;
        vec3 c4Color = vec3(1., 0., 0.);
        float c4 = length(coords4) - 0.05;
...
export default function Shader969() {
