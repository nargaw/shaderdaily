...
const fragmentShader = glsl`
    ...
    void main()
    {
        ...
        float d = sdfCircle(coords - offset, 0.015);
        float d2 = sdfCircle(coords - offset2, 0.025);
        float d3 = sdfCircle(coords - offset3 , 0.035);
        float d4 = sdfCircle(coords - offset4, 0.045);
        float d5 = sdfCircle(coords - offset5, 0.055);
        float d6 = sdfCircle(coords - offset6, 0.065);
        float d7 = sdfCircle(coords - offset7, 0.075);
        float d8 = sdfCircle(coords - offset8, 0.085);
...
export default function Shader762()
{
